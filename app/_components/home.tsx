...
function Section(props) {
  ...
  return (
    <motion.section className={`
        w-screen h-screen p-8 max-w-screen-2xl mx-auto flex flex-col t justify-center
        `}    
        initial={{
          opacity:0,
          y:10
  ...
  <div className="relative overflow-hidden before:absolute before:top-0 before:left-1/2  before:bg-no-repeat before:bg-top before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 ">
    <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
      ...
      <div className="flex justify-center">
        <a
          className="inline-flex items-center gap-x-2 bg-white border border-gray-200 text-xs text-textcolor p-2 px-3 rounded-full transition hover:border-gray-300 dark:bg-gray-800 dark:border-gray-700 dark:hover:border-gray-600 dark:text-gray-400"
          href="https://youcefbenziane.me"
        >
      ...
      <div className="mt-5 max-w-3xl text-center mx-auto">
        <p className="text-lg text-gray-600 dark:text-gray-400">
          NetDoer is an online platform that helps in sharing knowledge about computer science 
          through courses and blogs,helping people creating careers
          .join us or study with us
        </p>
      </div>
      {/* Buttons */}
        ...
        <div className="space-y-6 sm:space-y-8">
          ...
          <ul role="list" className="space-y-2 sm:space-y-4">
            <li className="flex space-x-3">
              ...
              {/* End Solid Check */}
              <span className="text-sm sm:text-base text-gray-500">
                <span className="font-bold">cheap &amp; reasonable</span> price
              </span>
            </li>
            <li className="flex space-x-3">
              {/* Solid Check */}
              ...
              {/* End Solid Check */}
              <span className="text-sm sm:text-base text-gray-500">
                Live <span className="font-bold">courses</span>
              </span>
            </li>
            <li className="flex space-x-3">
              {/* Solid Check */}
