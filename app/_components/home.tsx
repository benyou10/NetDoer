...
function Section(props : any) {
  ...
  return (
    <motion.section className={`
        w-screen h-screen   mx-auto flex flex-col t justify-center
        `}    
        initial={{
          opacity:0,
          y:10
...
<Section>
  ...
  <div className="relative overflow-hidden before:absolute before:top-0 before:left-1/2  before:bg-no-repeat before:bg-top before:w-full before:h-full before:-z-[1] before:transform before:-translate-x-1/2 ">
      <video className='w-[100vw] loop h-full' muted autoPlay src="/2024-03-29 16-43-47.mp4"></video>
    <div className='bg-darkblue w-[100vw] z-100 h-[100vh] opacity-40 absolute top-0'>
      
    </div>
    <h1 className='top-[60%] absolute text-center w-[100vw]  text-5xl font-extrabold'>our agency thrive on your success</h1>
  </div>
  </Section>
