...
const Page = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col border-2 border-white overflow-hidden p-8 rounded-xl shadow-large bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-900 via-gray-900 to-cyan-800 w-80">
          <div className="px-6 py-8 sm:p-10 sm:pb-6">
            <div className="items-center w-full justify-center grid grid-cols-1 text-left">
              <div>
                <h2 className="text-white font-bold text-lg lg:text-3xl">Corporate</h2>
                <p className="text-white tracking-tight xl:text-2xl mt-5">
              ...
              <div className="mt-2">
                <p>
                  <span className="text-white tracking-tight xl:text-4xl">$35</span>
                  <span className="text-white font-medium text-base">/mo</span>
                </p>
              </div>
            </div>
          </div>
